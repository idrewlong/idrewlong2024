...
<section class="brands_home">
        <div class="brands_div">
                  ...
                  <div class="brands">
                      <div class="brands_bg group"
                          style="background-image:url('/brands/fat8.webp')">
                          <div
                              class="brands_txt_div">
                              <h2 class="mt-4 text-xl font-semibold text-white capitalize">Fat8 Media</h2>
                              <p class="mt-2 text-lg tracking-wider text-orange-500 uppercase ">Branding & Web Development</p>
                          </div>
                      </div>
                      ...
                      <div class="brands_bg group"
                          ...
                          <div
                              ...
                              <p class="mt-2 text-lg tracking-wider text-orange-500 uppercase ">Branding</p>
                          </div>
                      </div>
